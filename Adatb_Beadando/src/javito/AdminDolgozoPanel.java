...
public class AdminDolgozoPanel extends JFrame {

	private JPanel contentPane;
	public JFrame frame;
	private JTable table;
	
	String Tabla = "DOLGOZO";
	...
	public AdminDolgozoPanel() {
		...
		btnNewButton_5 = new JButton("Főmenü");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					connection = sqliteConnection.dbConnection();
					String query = "Insert into " + Tabla+" (KOD_NEV,NEV,JELSZO ,EMAIL,CIM, MUNKAKOR) values(?,?,?,?,?,?)";
					PreparedStatement pst = connection.prepareStatement(query);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					connection = sqliteConnection.dbConnection();
					String query = "Update " + Tabla +" set KOD_NEV='" + textField.getText() + "', NEV='"
							+ textField_1.getText() + "', JELSZO='" + textField_2.getText() + "', EMAIL='"
							+ textField_3.getText() + "',CIM='" + textField_4.getText() + "',MUNKAKOR='"
							+ textField_5.getText() + "' where KOD_NEV='" + textField.getText() + "';";
					PreparedStatement pst = connection.prepareStatement(query);
					pst.execute();
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					connection = sqliteConnection.dbConnection();
					String query = "delete from " + Tabla+" where KOD_NEV='" + textField.getText() + "';";
					PreparedStatement pst = connection.prepareStatement(query);
