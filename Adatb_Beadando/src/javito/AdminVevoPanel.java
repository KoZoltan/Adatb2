...
public class AdminVevoPanel extends JFrame {
	...
	public AdminVevoPanel() {
		...
		textArea.setBounds(744, 15, 89, 16);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					connection = sqliteConnection.dbConnection();
					String query = "Insert into " + Tabla+" (VKOD , VNEV , VCIM , SZULDAT ) values(?,?,?,?)";
					PreparedStatement pst = connection.prepareStatement(query);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					connection = sqliteConnection.dbConnection();
					String query = "Update " + Tabla+" set VKOD='" + textField.getText() + "', VNEV='"
							+ textField_1.getText() + "', VCIM='" + textField_2.getText() + "', SZULDAT='"
							+ textField_3.getText() + "';";
					PreparedStatement pst = connection.prepareStatement(query);
					pst.execute();
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					connection = sqliteConnection.dbConnection();
					String query = "delete from " + Tabla+" where VKOD='" + textField.getText() + "';";
					PreparedStatement pst = connection.prepareStatement(query);
